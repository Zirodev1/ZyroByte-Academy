    ...
    <footer className="bg-gray-900 text-white pt-12 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          {/* About section */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-blue-400">ZyroByte Academy</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/courses" className="text-gray-300 hover:text-white transition duration-200">Courses</Link></li>
          ...
          {/* Learning Paths */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-blue-400">Learning Paths</h3>
            <ul className="space-y-2">
              <li><Link to="/courses/frontend" className="text-gray-300 hover:text-white transition duration-200">Frontend Development</Link></li>
              <li><Link to="/courses/backend" className="text-gray-300 hover:text-white transition duration-200">Backend Development</Link></li>
              <li><Link to="/courses/fullstack" className="text-gray-300 hover:text-white transition duration-200">Full Stack Development</Link></li>
              <li><Link to="/courses/cybersecurity" className="text-gray-300 hover:text-white transition duration-200">Cybersecurity</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center">
                ...
                <span className="text-gray-300">support@zyrobyteacademy.com</span>
              </li>
              <li className="flex items-center">
                <svg className="w-5 h-5 mr-2 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4">
            ...
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-600 transition duration-200">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
